...
namespace IO.Swagger.Api
{
    ...
    public partial class AnagraficheApi : IAnagraficheApi
    {
        ...
        public ApiResponse< FasceIxCeResponse > GetFasceIxCeContrattoClienteFinaleWithHttpInfo (string tipoFascia, string xAuthorization)
        {
            ...
            var localVarPath = "/api/v2/contratti/clientefinale/fasceixce/{tipoFascia}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< FasceIxResponse > GetFasceIxFeContrattoClienteFinaleWithHttpInfo (string xAuthorization)
        {
            // verify the required parameter 'xAuthorization' is set
            if (xAuthorization == null)
                throw new ApiException(400, "Missing required parameter 'xAuthorization' when calling AnagraficheApi->GetFasceIxFeContrattoClienteFinale");

            var localVarPath = "/api/v2/contratti/clientefinale/fasceixfe";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
