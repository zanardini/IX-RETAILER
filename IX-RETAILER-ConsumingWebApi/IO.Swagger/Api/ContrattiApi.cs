...
namespace IO.Swagger.Api
{
    ...
    public interface IContrattiApi : IApiAccessor
    {
        ...
        /// <summary>
        /// Aggiunge un cliente (compresa la aoo) ad un contratto cliente standard
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
    ...
    public partial class ContrattiApi : IContrattiApi
    {
        ...
        public ApiResponse< System.IO.Stream > GetCartaceoContrattoWithHttpInfo (string id, string xAuthorization)
        {
            ...
            var localVarPath = "/api/v2/contratti/{id}/cartaceo";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< ContrattoResponse > GetContrattoWithHttpInfo (string id, string xAuthorization)
        {
            ...
            var localVarPath = "/api/v2/contratti/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< StatoContrattoResponse > GetStatoContrattoWithHttpInfo (string id, string xAuthorization)
        {
            ...
            var localVarPath = "/api/v2/contratti/{id}/stato";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< ContrattoUtenteResponse > InsertUtenteWithHttpInfo (string id, ContrattoUtenteRequestV2 utente, string xAuthorization)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ContrattiApi->InsertUtente");
            // verify the required parameter 'utente' is set
            if (utente == null)
                throw new ApiException(400, "Missing required parameter 'utente' when calling ContrattiApi->InsertUtente");
            // verify the required parameter 'xAuthorization' is set
            if (xAuthorization == null)
                throw new ApiException(400, "Missing required parameter 'xAuthorization' when calling ContrattiApi->InsertUtente");
        ...
        public ApiResponse<Object> UploadControfirmatoWithHttpInfo (string id, System.IO.Stream _file, string xAuthorization)
        {
            ...
            var localVarPath = "/api/v2/contratti/{id}/controfirmato";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
