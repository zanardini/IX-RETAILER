...
{
    /// <summary>
    /// AooModuloIxCeResponse
    /// </summary>
    [DataContract]
    public partial class AooModuloIxCeResponse :  IEquatable<AooModuloIxCeResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines TipoFirma
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AooModuloIxCeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AooModuloIxCeResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AooModuloIxCeResponse" /> class.
        /// </summary>
        ...
        public AooModuloIxCeResponse(FasciaIxCeInfo fascia = default(FasciaIxCeInfo), FasciaIxCeInfo fasciaAnniSuccessiva = default(FasciaIxCeInfo), TipoFirmaEnum tipoFirma = default(TipoFirmaEnum), ResponsabileConservazioneInfo responsabileConservazione = default(ResponsabileConservazioneInfo), PeriodoImpostaInfo periodoImposta = default(PeriodoImpostaInfo))
        {
            // to ensure "tipoFirma" is required (not null)
            if (tipoFirma == null)
            {
                throw new InvalidDataException("tipoFirma is a required property for AooModuloIxCeResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AooModuloIxCeResponse {\n");
        ...
        {
            return this.Equals(input as AooModuloIxCeResponse);
        }

        /// <summary>
        /// Returns true if AooModuloIxCeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AooModuloIxCeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AooModuloIxCeResponse input)
        {
            if (input == null)
                return false;
