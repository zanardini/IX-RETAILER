...
{
    /// <summary>
    /// CentroServiziModuloIxCeRequest
    /// </summary>
    [DataContract]
    public partial class CentroServiziModuloIxCeRequest :  IEquatable<CentroServiziModuloIxCeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CentroServiziModuloIxCeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CentroServiziModuloIxCeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CentroServiziModuloIxCeRequest" /> class.
        /// </summary>
        ...
        public CentroServiziModuloIxCeRequest(FasciaIxCeInfo fascia = default(FasciaIxCeInfo), FasciaIxCeInfo fasciaAnniSuccessiva = default(FasciaIxCeInfo), ResponsabileConservazioneInfo responsabileConservazione = default(ResponsabileConservazioneInfo))
        {
            // to ensure "fascia" is required (not null)
            if (fascia == null)
            {
                throw new InvalidDataException("fascia is a required property for CentroServiziModuloIxCeRequest and cannot be null");
            }
            else
            {
                this.Fascia = fascia;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CentroServiziModuloIxCeRequest {\n");
        ...
        {
            return this.Equals(input as CentroServiziModuloIxCeRequest);
        }

        /// <summary>
        /// Returns true if CentroServiziModuloIxCeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CentroServiziModuloIxCeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CentroServiziModuloIxCeRequest input)
        {
            if (input == null)
                return false;
