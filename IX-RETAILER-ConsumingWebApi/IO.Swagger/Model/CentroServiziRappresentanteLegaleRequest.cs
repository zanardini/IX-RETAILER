...
{
    /// <summary>
    /// CentroServiziRappresentanteLegaleRequest
    /// </summary>
    [DataContract]
    public partial class CentroServiziRappresentanteLegaleRequest :  IEquatable<CentroServiziRappresentanteLegaleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CentroServiziRappresentanteLegaleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CentroServiziRappresentanteLegaleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CentroServiziRappresentanteLegaleRequest" /> class.
        /// </summary>
        ...
        public CentroServiziRappresentanteLegaleRequest(string nome = default(string), string cognome = default(string), string codiceFiscale = default(string), string cittadinanza = default(string))
        {
            // to ensure "nome" is required (not null)
            if (nome == null)
            {
                throw new InvalidDataException("nome is a required property for CentroServiziRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
                this.Nome = nome;
            ...
            if (cognome == null)
            {
                throw new InvalidDataException("cognome is a required property for CentroServiziRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("codiceFiscale is a required property for CentroServiziRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("cittadinanza is a required property for CentroServiziRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CentroServiziRappresentanteLegaleRequest {\n");
        ...
        {
            return this.Equals(input as CentroServiziRappresentanteLegaleRequest);
        }

        /// <summary>
        /// Returns true if CentroServiziRappresentanteLegaleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CentroServiziRappresentanteLegaleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CentroServiziRappresentanteLegaleRequest input)
        {
            if (input == null)
                return false;
