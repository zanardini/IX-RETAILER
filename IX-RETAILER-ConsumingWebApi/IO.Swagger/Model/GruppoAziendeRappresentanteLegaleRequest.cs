...
{
    /// <summary>
    /// GruppoAziendeRappresentanteLegaleRequest
    /// </summary>
    [DataContract]
    public partial class GruppoAziendeRappresentanteLegaleRequest :  IEquatable<GruppoAziendeRappresentanteLegaleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GruppoAziendeRappresentanteLegaleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GruppoAziendeRappresentanteLegaleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GruppoAziendeRappresentanteLegaleRequest" /> class.
        /// </summary>
        ...
        public GruppoAziendeRappresentanteLegaleRequest(string nome = default(string), string cognome = default(string), string codiceFiscale = default(string), string cittadinanza = default(string))
        {
            // to ensure "nome" is required (not null)
            if (nome == null)
            {
                throw new InvalidDataException("nome is a required property for GruppoAziendeRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
                this.Nome = nome;
            ...
            if (cognome == null)
            {
                throw new InvalidDataException("cognome is a required property for GruppoAziendeRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("codiceFiscale is a required property for GruppoAziendeRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("cittadinanza is a required property for GruppoAziendeRappresentanteLegaleRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GruppoAziendeRappresentanteLegaleRequest {\n");
        ...
        {
            return this.Equals(input as GruppoAziendeRappresentanteLegaleRequest);
        }

        /// <summary>
        /// Returns true if GruppoAziendeRappresentanteLegaleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GruppoAziendeRappresentanteLegaleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GruppoAziendeRappresentanteLegaleRequest input)
        {
            if (input == null)
                return false;
