...
{
    /// <summary>
    /// LegaleRappresentanteAoo
    /// </summary>
    [DataContract]
    public partial class LegaleRappresentanteAoo :  IEquatable<LegaleRappresentanteAoo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegaleRappresentanteAoo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LegaleRappresentanteAoo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LegaleRappresentanteAoo" /> class.
        /// </summary>
        ...
        public LegaleRappresentanteAoo(string nome = default(string), string cognome = default(string), string codiceFiscale = default(string), string cittadinanza = default(string))
        {
            // to ensure "nome" is required (not null)
            if (nome == null)
            {
                throw new InvalidDataException("nome is a required property for LegaleRappresentanteAoo and cannot be null");
            }
            else
            {
                this.Nome = nome;
            ...
            if (cognome == null)
            {
                throw new InvalidDataException("cognome is a required property for LegaleRappresentanteAoo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("codiceFiscale is a required property for LegaleRappresentanteAoo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("cittadinanza is a required property for LegaleRappresentanteAoo and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LegaleRappresentanteAoo {\n");
        ...
        {
            return this.Equals(input as LegaleRappresentanteAoo);
        }

        /// <summary>
        /// Returns true if LegaleRappresentanteAoo instances are equal
        /// </summary>
        /// <param name="input">Instance of LegaleRappresentanteAoo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LegaleRappresentanteAoo input)
        {
            if (input == null)
                return false;
