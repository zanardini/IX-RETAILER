...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MetadatoResponse :  IEquatable<MetadatoResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines TipoCampo
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadatoResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadatoResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadatoResponse" /> class.
        /// </summary>
        ...
        public MetadatoResponse(string codiceCampo = default(string), string descrizioneCampo = default(string), bool? obbligatorio = default(bool?), TipoCampoEnum tipoCampo = default(TipoCampoEnum))
        {
            // to ensure "codiceCampo" is required (not null)
            if (codiceCampo == null)
            {
                throw new InvalidDataException("codiceCampo is a required property for MetadatoResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("descrizioneCampo is a required property for MetadatoResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("obbligatorio is a required property for MetadatoResponse and cannot be null");
            }
            else
            {
            ...
            if (tipoCampo == null)
            {
                throw new InvalidDataException("tipoCampo is a required property for MetadatoResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MetadatoResponse {\n");
        ...
        {
            return this.Equals(input as MetadatoResponse);
        }

        /// <summary>
        /// Returns true if MetadatoResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadatoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadatoResponse input)
        {
            if (input == null)
                return false;
