...
{
    /// <summary>
    /// UpdateRagioneSocialeClienteRequest
    /// </summary>
    [DataContract]
    public partial class UpdateRagioneSocialeClienteRequest :  IEquatable<UpdateRagioneSocialeClienteRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRagioneSocialeClienteRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRagioneSocialeClienteRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRagioneSocialeClienteRequest" /> class.
        /// </summary>
        /// <param name="ragioneSociale">ragioneSociale (required).</param>
        public UpdateRagioneSocialeClienteRequest(string ragioneSociale = default(string))
        {
            // to ensure "ragioneSociale" is required (not null)
            if (ragioneSociale == null)
            {
                throw new InvalidDataException("ragioneSociale is a required property for UpdateRagioneSocialeClienteRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateRagioneSocialeClienteRequest {\n");
        ...
        {
            return this.Equals(input as UpdateRagioneSocialeClienteRequest);
        }

        /// <summary>
        /// Returns true if UpdateRagioneSocialeClienteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRagioneSocialeClienteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRagioneSocialeClienteRequest input)
        {
            if (input == null)
                return false;
